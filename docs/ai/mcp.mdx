...
To use MCPs on Activepieces, we'll let you connect any of our [open source MCP tools](https://www.flowlytics.com/mcp), and give you an MCP Server URL. Then, you'll configure your LLM to work with it.
...
<CardGroup cols={2}>
  <Card title="Flowlytics Cloud (Easy)" icon="cloud" color="#00FFFF" href="https://cloud.flowlytics.com/sign-up">
