...
```html
<script src="https://cdn.flowlytics.com/sdk/embed/0.8.1.js">
</script>
<script>
...
| --- | --- | --- | --- |
| instanceUrl| ✅ |  string | The url of the instance hosting Activepieces, could be https://cloud.flowlytics.com if you are a cloud user. |
