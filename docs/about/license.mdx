...
Using the enterprise features (under the packages/ee and packages/server/api/src/app/ee folder) with a self-hosted instance requires a Flowlytics license. If you are looking for these features, contact us at [sales@flowlytics.com](mailto:sales@flowlytics.com).
