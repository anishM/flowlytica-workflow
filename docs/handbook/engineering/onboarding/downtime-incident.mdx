...
1. **Tell Your Users**:
   - Let your users know there’s an issue. Post on [Community](https://community.flowlytics.com) and Discord.
...
1. **Use Clickstack**:
   - Go to [https://watch.flowlytics.com](https://watch.flowlytics.com).
