...
export const defaultTheme = generateTheme({
    primaryColor: '#02c1fe',
    websiteName: 'Flowlytics - Workflow',
    fullLogoUrl: '/images/flowlytics-logo-dark.svg',
    favIconUrl: '/images/flowlytics-favicon.svg',
    logoIconUrl: '/images/flowlytics-favicon.svg',
})
