  ...
  return (
    <Alert className="mb-6">
      ...
      <AlertDescription>
        ...
        {t(
          'If you would like to expose your MCP server to the internet, please set the AP_FRONTEND_URL environment variable to the public URL of your Flowlytics - Workflow instance.',
        )}
      </AlertDescription>
    </Alert>
  );
